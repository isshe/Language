...
public class Net1314080903212MultiChat extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.net1314080903212_main);
        ...
        RHhandler = new Handler()
        {
            ...
            public void handleMessage(Message msg)
            {
                if (msg.what == 0x789)
                {
                    //从网络上下载历史数据已经好了,再读一次文件以显示
                    Net1314080903212RH read_history = new Net1314080903212RH();
                    read_history.RHshow = show;
                    read_history.file_read();
                }
            }
        };
        //读取历史记录
        Net1314080903212RH read_history = new Net1314080903212RH();
        read_history.RHshow = show;
        read_history.RHhandler = RHhandler;
        read_history.file_read();
